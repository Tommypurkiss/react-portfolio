        ...
        <div className="Main-content-wrapper">
            ...
            <section className="skills-section" id="skills-section">
                ...
                <div className="skills-container row ">
                    ...
                    <div className="skills-card">
                        <div className="skills-img">
                            <img src={require('../imgs/web-tech-logos/css-5.svg')} alt="CSS3"></img>
                    ...
                    <div className="skills-card">
                        <div className="skills-img">
                            <img src={require('../imgs/web-tech-logos/javascript-4.svg')} alt="JavaScript"></img>
                        </div>
                        <div className="skills-text">
                            Javascript
                        </div>
                    ...
                    <div className="skills-card">
                        <div className="skills-img">
                            <img src={require('../imgs/web-tech-logos/react-2.svg')} alt="ReactJS"></img>
                        </div>
                        <div className="skills-text">
                            ReactJS
                        </div>
                    ...
                    <div className="skills-card">
                        <div className="skills-img">
                            <img src={require('../imgs/web-tech-logos/firebase-1.svg')} alt="Firebase"></img>
                        </div>
                        <div className="skills-text">
                            Firebase
                        </div>
                    ...
                    <div className="skills-card">
                        <div className="skills-img">
                            <img src={require('../imgs/web-tech-logos/adobe-xd-1.svg')} alt="Adobe XD"></img>
                        </div>
                        <div className="skills-text">
                            Adobe XD
                        </div>
                ...
                <div className="contact-container">
                    ...
                    <div className="contact-logos">
                        <div className="logo-left">
                            <a href="mailto:tommypurkiss1@gmail.com" target="_blank">
                                <img src={require('../imgs/contact-logos/email.png')} alt="email"></img>
                            </a>
                        </div>
                        <div className="logo-right">
                            <a href="https://www.instagram.com/tommypdev/?hl=en" target="_blank">
                                <img src={require('../imgs/contact-logos/instagram.png')} alt="instagram"></img>
                            </a>
                            <a href="https://www.linkedin.com/in/tommypurkiss/" target="_blank">
                                <img src={require('../imgs/contact-logos/linkedin.png')} alt="linkedin"></img>

                            </a>
                            <a href="https://github.com/Tommypurkiss" target="_blank">
                                <img src={require('../imgs/contact-logos/github.png')} alt="github"></img>
